...
function SingleSwing({ series, animClass, seatColor, onPush, isPushing }: SwingProps) {
...
export default function SeriesTripleSwingsSection({ topSeries }: SeriesTripleSwingsSectionProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[440px] mx-auto overflow-hidden" style={{ height: 280 }}>
        {/* 꼭대기 가로 봉 (녹슨 금속) */}
        <div
